function result=sim_scatter_heatmap2(scatterer_positions,m,x,phiSteps,thetaSteps, x_range,y_range,z_range,x_reg,y_reg,z_reg,r,photons,backscatter_prob)
  photons
  ...
  %Remove all photons which leave the media from our heatmap data
    ...
    while k <= size(heatmap,1),
      ...
      if scattered,
        ...
        path_theta = tetascan_dist2(m,x,phiSteps);
